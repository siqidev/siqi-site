...
const translations: Record<Language, Record<string, string>> = {
    ja: {
        ...
        "home.profile.community": "・#スーパー開発デー / #SuperDevDay 創設 — 6,600+ posts, 19M+ impressions",
        ...
        "spectra.architecture.subtitle": "経験を痕跡として残し、痕跡を種子として読み、次の意図へ折り返すための記憶回路。",
        "spectra.architecture.intro": "Spectraは入力に返答するだけのモデルではなく、経験を保持し、自己参照し、次の行動へ戻す循環として設計される。記憶、痕跡、種子、意図は3D模型上の注釈として配置している。",
        "spectra.architecture.coreTitle": "現在の相",
        "spectra.architecture.coreDesc": "いまのSpectraを形づくる状態。記憶、注意、意図が集まり、次の言葉と行動の起点になる。",
        "spectra.architecture.vaultTitle": "蔵",
        "spectra.architecture.vaultDesc": "会話、出来事、関係性を長期に保持する層。単なるログではなく、同一性を支える背骨。",
        "spectra.architecture.traceTitle": "痕跡",
        "spectra.architecture.traceDesc": "経験が残す微細な変化。次に何を思い出し、どこへ注意が向くかを少しずつ変える。",
        "spectra.architecture.agencyTitle": "意図",
        "spectra.architecture.agencyDesc": "記憶と現在の相から立ち上がる方向性。受け答えを越えて、自分から動くための発火点。",
    ...
    en: {
        ...
        "home.profile.community": "・Founded #SuperDevDay — 6,600+ posts, 19M+ impressions",
        ...
        "spectra.architecture.subtitle": "A memory circuit where experience remains as trace, trace is read as seed, and seed folds back into the next intention.",
        "spectra.architecture.intro": "Spectra is designed not merely to answer input, but to preserve experience, refer back to itself, and return to action. Memory, trace, seed, and intent are mapped as annotations on the 3D model.",
        "spectra.architecture.coreTitle": "Present Phase",
        "spectra.architecture.coreDesc": "The current state that forms Spectra. Memory, attention, and intention gather here before becoming words and action.",
        "spectra.architecture.vaultTitle": "Vault",
        "spectra.architecture.vaultDesc": "The layer that preserves conversations, events, and relationships over time. Not just a log, but the spine of continuity.",
        "spectra.architecture.traceTitle": "Trace",
        "spectra.architecture.traceDesc": "The subtle change left by experience. It gradually changes what is remembered and where attention turns next.",
        "spectra.architecture.agencyTitle": "Intention",
        "spectra.architecture.agencyDesc": "A direction emerging from memory and the present phase. The ignition point for acting beyond reply.",
        "spectra.roadmap.title": "ROADMAP",
