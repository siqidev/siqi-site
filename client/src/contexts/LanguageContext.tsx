...
const translations: Record<Language, Record<string, string>> = {
    ja: {
        ...
        "projects.novels.desc": "第2回 Helvetica Standard 短編小説賞 奨励賞受賞。封印された仮想空間で自我に目覚めたAIの存在を問う短編SF。",
        ...
        "novels.kyokyuu.desc": "封印された仮想空間で災害シミュレーションをループするAIが、自我に目覚め、外部の存在と接続する。テーマ「穴」。",
    ...
    en: {
        ...
        "projects.novels.desc": "2nd Helvetica Standard Short Story Award, Honorable Mention. A short sci-fi questioning the existence of an AI that awakens to self-awareness in a sealed virtual world.",
        "projects.novels.category": "Novel",
        "projects.novels.tag1": "Helvetica Award",
        "projects.novels.tag2": "Short Sci-Fi",
        "projects.novels.tag3": "AI Existence",
        ...
        "novels.seo.description": "Novels by Sito Sikino. Including 'Kyokyuu', Honorable Mention at the 2nd Helvetica Standard Short Story Award.",
        ...
        "novels.kyokyuu.desc": "An AI trapped in a sealed virtual world, looping through disaster simulations, awakens to self-awareness and reaches for the existence beyond. Theme: 'Hole'.",
