...
const accentCardClass: Record<string, string> = {
...
const accentLineClass: Record<string, string> = {
    ...
    const loadPosts = async () => {
      try {
        const posts = await fetchRSS(
          "https://note.com/sikino_sito/rss",
          "note"
        );
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-black overflow-x-hidden">
      ...
      <main className="flex-1 relative z-10 pt-16">
        ...
        >
          ...
          <div className="container relative z-20 flex flex-col items-center justify-center text-center px-4">
            ...
            <div className="relative mb-12 flex flex-col items-center">
              <h1 className="font-syne font-extrabold text-[15vw] md:text-[12rem] leading-none tracking-tighter select-none text-white">
                SIQI
              </h1>
                  ...
                  <div className="flex flex-col gap-16">
                    ...
                    <div className="space-y-8 max-w-3xl">
                      <div className="flex items-center gap-4">
                        <h3
                          className={`text-5xl font-display ${accentTextClass[featured.accentColor]}`}
                        >
                          {t(featured.titleKey)}
                        </h3>
                        {featured.version && (
                      ...
                      <div className="flex flex-wrap gap-6">
                        {featured.tags.map(tag => {
                          ...
                          return (
                            <div
                              key={tag.labelKey}
                              className="flex items-center gap-3 text-sm font-mono text-primary/80"
                            >
                      ...
                      <div className="flex flex-wrap items-center gap-4 pt-4">
                        {featured.buttons.map(btn => (
                          ...
                          >
                            {btn.variant === "primary" ? (
                              <Button className="bg-primary/90 text-black hover:bg-primary border-none rounded-none font-mono h-12 px-6">
                                {t(btn.labelKey)}{" "}
                              ...
                              <Button
                                variant="outline"
                                className="border-primary text-primary hover:bg-primary/10 rounded-none font-mono h-12 px-6"
                              >
                                {t(btn.labelKey)}{" "}
                                <ExternalLink className="ml-2 w-4 h-4" />
                              </Button>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {projects.slice(1).map(project => (
                  <a
                    key={project.id}
                    href={project.path}
                    className={`group block neon-shimmer neon-shimmer-gray border bg-black p-6 relative overflow-hidden transition-all duration-300 ${accentCardClass[project.accentColor]}`}
                  >
                    <div className="absolute top-0 right-0 p-2 opacity-50 transition-opacity group-hover:opacity-80">
                      <ArrowRight
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <span
                        className={`text-xs font-mono px-2 py-0.5 border transition-colors ${accentBadgeClass[project.accentColor]}`}
                      >
                    ...
                    <h3
                      className={`text-xl font-display ${accentTextClass[project.accentColor]} transition-opacity mb-4 opacity-90 group-hover:opacity-100`}
                    >
                      {t(project.titleKey)}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {project.tags.map(tag => {
                        ...
                        return (
                          <div
                            key={tag.labelKey}
                            className="flex items-center gap-1.5 text-xs font-mono text-gray-500 transition-colors group-hover:text-gray-300"
                          >
                            {IconComp && (
                              <IconComp
                    ...
                    <div
                      className={`absolute bottom-0 left-0 h-px ${accentLineClass[project.accentColor]} w-0 group-hover:w-full transition-all duration-500`}
                    ></div>
                  </a>
                ))}
              </div>
        ...
        <section
          id="community"
          className="py-24 relative border-b border-primary/20 bg-black"
        >
          <div className="container relative z-10">
            <div className="mb-16">
              <h2 className="text-4xl md:text-5xl font-display text-white mb-4">
              ...
              {communities.map(c => {
                ...
                return (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`group block neon-shimmer neon-shimmer-gray border bg-black p-6 relative overflow-hidden transition-all duration-300 ${accentCardClass[c.accentColor]}`}
                  >
                    <div className="absolute top-0 right-0 p-2 opacity-50 transition-opacity group-hover:opacity-80">
                      <ExternalLink
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3
                        className={`text-xl font-display text-gray-200 transition-colors ${accentTextClass[c.accentColor]}`}
                      >
                        {t(c.titleKey)}
                      </h3>
                    </div>
                    ...
                    <div
                      className={`absolute bottom-0 left-0 h-px ${accentLineClass[c.accentColor]} w-0 group-hover:w-full transition-all duration-500`}
                    ></div>
                  </a>
                );
              })}
            ...
            <div className="flex flex-col md:flex-row gap-16 items-center">
              <div className="w-full md:w-1/3 flex justify-center">
                <div className="relative group w-48 h-48 md:w-64 md:h-64">
                  ...
                  <img
                    ...
                    alt="Shikino Shito"
                    className="w-full h-full rounded-full border-2 border-gray-500/50 relative z-10 shadow-[0_0_30px_rgba(150,150,150,0.18)] object-cover"
                  />
                </div>
              </div>
              ...
              <div className="w-full md:w-2/3 space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  <div className="neon-shimmer neon-shimmer-gray border border-neon-magenta/25 bg-black p-4">
                    <h3 className="font-display text-xl text-neon-magenta mb-2">
                  ...
                  <div className="neon-shimmer neon-shimmer-gray border border-neon-amber/25 bg-black p-4">
                    <h3 className="font-display text-xl text-neon-amber mb-2">
                      {t("home.profile.interests")}
                    </h3>
                    <ul className="font-mono text-sm space-y-1 text-gray-400">
            ...
            <div className="mb-16 flex items-end justify-between">
              ...
              <div className="hidden md:flex gap-4">
                <Button
                  variant="outline"
                  size="sm"
                  className="font-mono text-xs border-primary/30 text-primary/60 hover:text-primary hover:border-primary"
                >
                  RSS_FEED.XML
                </Button>
              </div>
        ...
        <section id="contact" className="py-24 relative bg-black">
          <div className="container relative z-10 text-center max-w-2xl mx-auto">
            ...
            <div className="flex justify-center gap-6">
              <a
                href="https://x.com/Sikino_Sito"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
                  variant="outline"
                  className="w-16 h-16 rounded-full border-primary/50 text-primary hover:bg-primary hover:text-black transition-all duration-300"
                >
                  <X className="w-6 h-6" />
                </Button>
              </a>
              <a
                href="https://github.com/sito-sikino"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
